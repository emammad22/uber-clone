  ...
  return (
    <ScrollView className="flex-1 bg-white">
      <View className="flex-1 bg-white">
        ...
        {/* That modal is responsible for displaying pending case */}
        <ReactNativeModal
        ...
        {/* That modal is responsible for displaying success case */}
        <ReactNativeModal isVisible={showSuccessModal}>
          <View className="bg-white px-7 py-9 rounded-2xl min-h-[300px]">
            <Image source={images.check} className="w-[110px] mx-auto h-[110px] my-5" />
            <Text className="font-JakartaBold text-3xl text-center">Verified</Text>
